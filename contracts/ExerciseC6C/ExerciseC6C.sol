...
contract ExerciseC6C {
    ...
    mapping(address => uint256) authorizedAccess;
    ...
    modifier isCallerAuthorized() {
        require(authorizedAccess[msg.sender] == 1, "Caller not authorized");
        _;
    }
    ...
    function authorizeAccess(address addr) public requireContractOwner {
        authorizedAccess[addr] = 1;
    }

    function deauthorizeAccess(address addr) public requireContractOwner {
        delete authorizedAccess[addr];
    }
